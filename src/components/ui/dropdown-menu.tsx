...
function DropdownMenuLabel({
  ...
  return (
    ...
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={classNameMerger('px-2 py-1.5 text-sm font-medium data-[inset]:pl-8', className)}
      {...props}
    />
  );
}
...
function DropdownMenuShortcut({ className, ...props }: React.ComponentProps<'span'>) {
  return (
    <span
      ...
      className={classNameMerger('text-muted-foreground ml-auto text-xs tracking-widest', className)}
      {...props}
    />
  );
}
